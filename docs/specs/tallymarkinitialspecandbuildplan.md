...
**PR2 sequencing decision:** until PR4 introduces the `salts` table and rotation, the generated map **MUST omit** the `salt` key. PR4 **MUST** add the current daily salt to the same atomically-generated map. No provisional, static, or unrotated salt may be written by PR2.
